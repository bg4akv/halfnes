...
public final class CPU {
	private final CPUAddrSpace ram;
	private int cycles; //increment to steal cycles from cpu
	public int clocks; //use for synchronizing with cpu
	private volatile int A, X, Y, S; // registers
	public volatile int PC;

	private volatile boolean carryFlag = false;
	private volatile boolean zeroFlag = false;
	private volatile boolean interruptsDisabled = true;
	private volatile boolean decimalModeFlag = false;
	private volatile boolean overflowFlag = false;
	private volatile boolean negativeFlag = false;
	private volatile boolean previntflag = false;

	private boolean nmi = false;
	private boolean prevnmi = false;
	...
	private final static String[] opcodes;
	...
	static {
		...
		opcodes[0x00] = "BRK";
		opcodes[0x01] = "ORA $(%2$02X%1$02X,x)";
		opcodes[0x02] = "KIL";
		opcodes[0x03] = "SLO $(%2$02X%1$02X,x)";
		opcodes[0x04] = "NOP $%1$02X";
		opcodes[0x05] = "ORA $%1$02X";
		opcodes[0x06] = "ASL $%1$02X";
		opcodes[0x07] = "SLO $%1$02X";
		opcodes[0x08] = "PHP";
		opcodes[0x09] = "ORA #$%1$02X";
		opcodes[0x0A] = "ASL A";
		opcodes[0x0B] = "ANC #$%1$02X";
		opcodes[0x0C] = "NOP $%2$02X%1$02X";
		opcodes[0x0D] = "ORA $%2$02X%1$02X";
		opcodes[0x0E] = "ASL $%2$02X%1$02X";
		opcodes[0x0F] = "SLO $%2$02X%1$02X";
		opcodes[0x10] = "BPL $%3$02X";
		opcodes[0x11] = "ORA ($%1$02X), y";
		opcodes[0x12] = "KIL";
		opcodes[0x13] = "SLO ($%1$02X), y";
		opcodes[0x14] = "NOP $%1$02X,x";
		opcodes[0x15] = "ORA $%1$02X,x";
		opcodes[0x16] = "ASL $%1$02X,x";
		opcodes[0x17] = "SLO $%1$02X,x";
		opcodes[0x18] = "CLC";
		opcodes[0x19] = "ORA $%2$02X%1$02X,y";
		opcodes[0x1A] = "NOP";
		opcodes[0x1B] = "SLO $%2$02X%1$02X,y";
		opcodes[0x1C] = "NOP $%2$02X%1$02X,x";
		opcodes[0x1D] = "ORA $%2$02X%1$02X,x";
		opcodes[0x1E] = "ASL $%2$02X%1$02X,x";
		opcodes[0x1F] = "SLO $%2$02X%1$02X,x";
		opcodes[0x20] = "JSR $%2$02X%1$02X";
		opcodes[0x21] = "AND $(%2$02X%1$02X,x)";
		opcodes[0x22] = "KIL";
		opcodes[0x23] = "RLA $(%2$02X%1$02X,x)";
		opcodes[0x24] = "BIT $%1$02X";
		opcodes[0x25] = "AND $%1$02X";
		opcodes[0x26] = "ROL $%1$02X";
		opcodes[0x27] = "RLA $%1$02X";
		opcodes[0x28] = "PLP";
		opcodes[0x29] = "AND #$%1$02X";
		opcodes[0x2A] = "ROL";
		opcodes[0x2B] = "ANC #$%1$02X";
		opcodes[0x2C] = "BIT $%2$02X%1$02X";
		opcodes[0x2D] = "AND $%2$02X%1$02X";
		opcodes[0x2E] = "ROL $%2$02X%1$02X";
		opcodes[0x2F] = "RLA $%2$02X%1$02X";
		opcodes[0x30] = "BMI $%3$02X";
		opcodes[0x31] = "AND ($%1$02X), y";
		opcodes[0x32] = "KIL";
		opcodes[0x33] = "RLA ($%1$02X), y";
		opcodes[0x34] = "NOP $%1$02X,x";
		opcodes[0x35] = "AND $%1$02X,x";
		opcodes[0x36] = "ROL $%1$02X,x";
		opcodes[0x37] = "RLA $%1$02X,x";
		opcodes[0x38] = "SEC";
		opcodes[0x39] = "AND $%2$02X%1$02X,y";
		opcodes[0x3A] = "NOP";
		opcodes[0x3B] = "RLA $%2$02X%1$02X,y";
		opcodes[0x3C] = "NOP $%2$02X%1$02X,x";
		opcodes[0x3D] = "AND $%2$02X%1$02X,x";
		opcodes[0x3E] = "ROL $%2$02X%1$02X,x";
		opcodes[0x3F] = "RLA $%2$02X%1$02X,x";
		opcodes[0x40] = "RTI";
		opcodes[0x41] = "EOR $(%2$02X%1$02X,x)";
		opcodes[0x42] = "KIL";
		opcodes[0x43] = "SRE $(%2$02X%1$02X,x)";
		opcodes[0x44] = "NOP $%1$02X";
		opcodes[0x45] = "EOR $%1$02X";
		opcodes[0x46] = "LSR $%1$02X";
		opcodes[0x47] = "SRE $%1$02X";
		opcodes[0x48] = "PHA";
		opcodes[0x49] = "EOR #$%1$02X";
		opcodes[0x4A] = "LSR";
		opcodes[0x4B] = "ALR #$%1$02X";
		opcodes[0x4C] = "JMP $%2$02X%1$02X";
		opcodes[0x4D] = "EOR $%2$02X%1$02X";
		opcodes[0x4E] = "LSR $%2$02X%1$02X";
		opcodes[0x4F] = "SRE $%2$02X%1$02X";
		opcodes[0x50] = "BVC $%3$02X";
		opcodes[0x51] = "EOR ($%1$02X), y";
		opcodes[0x52] = "KIL";
		opcodes[0x53] = "SRE ($%1$02X), y";
		opcodes[0x54] = "NOP $%1$02X,x";
		opcodes[0x55] = "EOR $%1$02X,x";
		opcodes[0x56] = "LSR $%1$02X,x";
		opcodes[0x57] = "SRE $%1$02X,x";
		opcodes[0x58] = "CLI";
		opcodes[0x59] = "EOR $%2$02X%1$02X,y";
		opcodes[0x5A] = "NOP";
		opcodes[0x5B] = "SRE $%2$02X%1$02X,y";
		opcodes[0x5C] = "NOP $%2$02X%1$02X,x";
		opcodes[0x5D] = "EOR $%2$02X%1$02X,x";
		opcodes[0x5E] = "LSR $%2$02X%1$02X,x";
		opcodes[0x5F] = "SRE $%2$02X%1$02X,x";
		opcodes[0x60] = "RTS";
		opcodes[0x61] = "ADC $(%2$02X%1$02X,x)";
		opcodes[0x62] = "KIL";
		opcodes[0x63] = "RRA $(%2$02X%1$02X,x)";
		opcodes[0x64] = "NOP $%1$02X";
		opcodes[0x65] = "ADC $%1$02X";
		opcodes[0x66] = "ROR $%1$02X";
		opcodes[0x67] = "RRA $%1$02X";
		opcodes[0x68] = "PLA";
		opcodes[0x69] = "ADC #$%1$02X";
		opcodes[0x6A] = "ROR";
		opcodes[0x6B] = "ARR #$%1$02X";
		opcodes[0x6C] = "JMP ($%2$02X%1$02X)";
		opcodes[0x6D] = "ADC $%2$02X%1$02X";
		opcodes[0x6E] = "ROR $%2$02X%1$02X";
		opcodes[0x6F] = "RRA $%2$02X%1$02X";
		opcodes[0x70] = "BVS $%3$02X";
		opcodes[0x71] = "ADC ($%1$02X), y";
		opcodes[0x72] = "KIL";
		opcodes[0x73] = "RRA ($%1$02X), y";
		opcodes[0x74] = "NOP $%1$02X,x";
		opcodes[0x75] = "ADC $%1$02X,x";
		opcodes[0x76] = "ROR $%1$02X,x";
		opcodes[0x77] = "RRA $%1$02X,x";
		opcodes[0x78] = "SEI";
		opcodes[0x79] = "ADC $%2$02X%1$02X,y";
		opcodes[0x7A] = "NOP";
		opcodes[0x7B] = "RRA $%2$02X%1$02X,y";
		opcodes[0x7C] = "NOP $%2$02X%1$02X,x";
		opcodes[0x7D] = "ADC $%2$02X%1$02X,x";
		opcodes[0x7E] = "ROR $%2$02X%1$02X,x";
		opcodes[0x7F] = "RRA $%2$02X%1$02X,x";
		opcodes[0x80] = "NOP #$%1$02X";
		opcodes[0x81] = "STA $(%2$02X%1$02X,x)";
		opcodes[0x82] = "NOP #$%1$02X";
		opcodes[0x83] = "SAX $(%2$02X%1$02X,x)";
		opcodes[0x84] = "STY $%1$02X";
		opcodes[0x85] = "STA $%1$02X";
		opcodes[0x86] = "STX $%1$02X";
		opcodes[0x87] = "SAX $%1$02X";
		opcodes[0x88] = "DEY";
		opcodes[0x89] = "NOP #$%1$02X";
		opcodes[0x8A] = "TXA";
		opcodes[0x8B] = "XAA #$%1$02X";
		opcodes[0x8C] = "STY $%2$02X%1$02X";
		opcodes[0x8D] = "STA $%2$02X%1$02X";
		opcodes[0x8E] = "STX $%2$02X%1$02X";
		opcodes[0x8F] = "SAX $%2$02X%1$02X";
		opcodes[0x90] = "BCC $%3$02X";
		opcodes[0x91] = "STA ($%1$02X), y";
		opcodes[0x92] = "KIL";
		opcodes[0x93] = "AHX ($%1$02X), y";
		opcodes[0x94] = "STY $%1$02X,x";
		opcodes[0x95] = "STA $%1$02X,x";
		opcodes[0x96] = "STX $%1$02X,y";
		opcodes[0x97] = "SAX $%1$02X,y";
		opcodes[0x98] = "TYA";
		opcodes[0x99] = "STA $%2$02X%1$02X,y";
		opcodes[0x9A] = "TXS";
		opcodes[0x9B] = "TAS $%2$02X%1$02X,y";
		opcodes[0x9C] = "SHY $%2$02X%1$02X,x";
		opcodes[0x9D] = "STA $%2$02X%1$02X,x";
		opcodes[0x9E] = "SHX $%2$02X%1$02X,y";
		opcodes[0x9F] = "AHX $%2$02X%1$02X,y";
		opcodes[0xA0] = "LDY #$%1$02X";
		opcodes[0xA1] = "LDA $(%2$02X%1$02X,x)";
		opcodes[0xA2] = "LDX #$%1$02X";
		opcodes[0xA3] = "LAX $(%2$02X%1$02X,x)";
		opcodes[0xA4] = "LDY $%1$02X";
		opcodes[0xA5] = "LDA $%1$02X";
		opcodes[0xA6] = "LDX $%1$02X";
		opcodes[0xA7] = "LAX $%1$02X";
		opcodes[0xA8] = "TAY";
		opcodes[0xA9] = "LDA #$%1$02X";
		opcodes[0xAA] = "TAX";
		opcodes[0xAB] = "LAX #$%1$02X";
		opcodes[0xAC] = "LDY $%2$02X%1$02X";
		opcodes[0xAD] = "LDA $%2$02X%1$02X";
		opcodes[0xAE] = "LDX $%2$02X%1$02X";
		opcodes[0xAF] = "LAX $%2$02X%1$02X";
		opcodes[0xB0] = "BCS $%3$02X";
		opcodes[0xB1] = "LDA ($%1$02X), y";
		opcodes[0xB2] = "KIL";
		opcodes[0xB3] = "LAX ($%1$02X), y";
		opcodes[0xB4] = "LDY $%1$02X,x";
		opcodes[0xB5] = "LDA $%1$02X,x";
		opcodes[0xB6] = "LDX $%1$02X,y";
		opcodes[0xB7] = "LAX $%1$02X,y";
		opcodes[0xB8] = "CLV";
		opcodes[0xB9] = "LDA $%2$02X%1$02X,y";
		opcodes[0xBA] = "TSX";
		opcodes[0xBB] = "LAS $%2$02X%1$02X,y";
		opcodes[0xBC] = "LDY $%2$02X%1$02X,x";
		opcodes[0xBD] = "LDA $%2$02X%1$02X,x";
		opcodes[0xBE] = "LDX $%2$02X%1$02X,y";
		opcodes[0xBF] = "LAX $%2$02X%1$02X,y";
		opcodes[0xC0] = "CPY #$%1$02X";
		opcodes[0xC1] = "CMP $(%2$02X%1$02X,x)";
		opcodes[0xC2] = "NOP #$%1$02X";
		opcodes[0xC3] = "DCP $(%2$02X%1$02X,x)";
		opcodes[0xC4] = "CPY $%1$02X";
		opcodes[0xC5] = "CMP $%1$02X";
		opcodes[0xC6] = "DEC $%1$02X";
		opcodes[0xC7] = "DCP $%1$02X";
		opcodes[0xC8] = "INY";
		opcodes[0xC9] = "CMP #$%1$02X";
		opcodes[0xCA] = "DEX";
		opcodes[0xCB] = "AXS #$%1$02X";
		opcodes[0xCC] = "CPY $%2$02X%1$02X";
		opcodes[0xCD] = "CMP $%2$02X%1$02X";
		opcodes[0xCE] = "DEC $%2$02X%1$02X";
		opcodes[0xCF] = "DCP $%2$02X%1$02X";
		opcodes[0xD0] = "BNE $%3$02X";
		opcodes[0xD1] = "CMP ($%1$02X), y";
		opcodes[0xD2] = "KIL";
		opcodes[0xD3] = "DCP ($%1$02X), y";
		opcodes[0xD4] = "NOP $%1$02X,x";
		opcodes[0xD5] = "CMP $%1$02X,x";
		opcodes[0xD6] = "DEC $%1$02X,x";
		opcodes[0xD7] = "DCP $%1$02X,x";
		opcodes[0xD8] = "CLD";
		opcodes[0xD9] = "CMP $%2$02X%1$02X,y";
		opcodes[0xDA] = "NOP";
		opcodes[0xDB] = "DCP $%2$02X%1$02X,y"; //did i delete this line somehow?
		opcodes[0xDC] = "NOP $%2$02X%1$02X,x";
		opcodes[0xDD] = "CMP $%2$02X%1$02X,x";
		opcodes[0xDE] = "DEC $%2$02X%1$02X,x";
		opcodes[0xDF] = "DCP $%2$02X%1$02X,x";
		opcodes[0xE0] = "CPX #$%1$02X";
		opcodes[0xE1] = "SBC $(%2$02X%1$02X,x)";
		opcodes[0xE2] = "NOP #$%1$02X";
		opcodes[0xE3] = "ISC $(%2$02X%1$02X,x)";
		opcodes[0xE4] = "CPX $%1$02X";
		opcodes[0xE5] = "SBC $%1$02X";
		opcodes[0xE6] = "INC $%1$02X";
		opcodes[0xE7] = "ISC $%1$02X";
		opcodes[0xE8] = "INX";
		opcodes[0xE9] = "SBC #$%1$02X";
		opcodes[0xEA] = "NOP";
		opcodes[0xEB] = "SBC #$%1$02X";
		opcodes[0xEC] = "CPX $%2$02X%1$02X";
		opcodes[0xED] = "SBC $%2$02X%1$02X";
		opcodes[0xEE] = "INC $%2$02X%1$02X";
		opcodes[0xEF] = "ISC $%2$02X%1$02X";
		opcodes[0xF0] = "BEQ $%3$02X";
		opcodes[0xF1] = "SBC ($%1$02X), y";
		opcodes[0xF2] = "KIL";
		opcodes[0xF3] = "ISC ($%1$02X), y";
		opcodes[0xF4] = "NOP $%1$02X,x";
		opcodes[0xF5] = "SBC $%1$02X,x";
		opcodes[0xF6] = "INC $%1$02X,x";
		opcodes[0xF7] = "ISC $%1$02X,x";
		opcodes[0xF8] = "SED";
		opcodes[0xF9] = "SBC $%2$02X%1$02X,y";
		opcodes[0xFA] = "NOP";
		opcodes[0xFB] = "ISC $%2$02X%1$02X,y";
		opcodes[0xFC] = "NOP $%2$02X%1$02X,x";
		opcodes[0xFD] = "SBC $%2$02X%1$02X,x";
		opcodes[0xFE] = "INC $%2$02X%1$02X,x";
		opcodes[0xFF] = "ISC $%2$02X%1$02X,x";
	}
	...
	private OutputStreamWriter debugLogWriter; //debug log writer

	public CPU(final CPUAddrSpace cpuram)
	{
		ram = cpuram;
	...
	public void startLog()
	{
		logging = true;
		try {
			debugLogWriter = new OutputStreamWriter(new FileOutputStream(new File("nesdebug.txt")), StandardCharsets.UTF_8);
		} catch (IOException e) {
	...
	public void startLog(String path)
	{
		logging = true;
		try {
			debugLogWriter = new OutputStreamWriter(new FileOutputStream(new File(path)), StandardCharsets.UTF_8);
		} catch (IOException e) {
			System.err.println("Cannot create debug log" + e.getLocalizedMessage());
		}
	}
	...
	public void init(Integer initialPC)
